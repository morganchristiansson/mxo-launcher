...
public:
    ...
    std::unique_ptr<CLTEventCriticalSectionHelper_0x4b3e20> connectCompletionHelper7c_;
    std::unique_ptr<CLTEventCriticalSectionHelper_0x4b3e20> closeCompletionHelper80_;
