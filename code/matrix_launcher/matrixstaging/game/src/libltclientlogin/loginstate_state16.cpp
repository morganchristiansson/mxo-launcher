...
const char* CLTLoginState_State16_0x4b0bb0::DebugName() const {
    return "CLTLoginState_State16_0x4b0bb0";
}

// anchor: launcher.exe:0x00420720 (vtable 0x004b0bb0 slot 3)
void CLTLoginState_State16_0x4b0bb0::Slot3_BeginOrContinue(CLTLoginState* upstreamOrArg) {
...
uint32_t CLTLoginState_State16_0x4b0bb0::Slot6_HandleSecondaryMessage(mxo::liblttcp::CMessageConnectionMessageRef_0x4ba23c* workItem) {
    (void)workItem;
    return PlaceholderStateAction(DebugName(), "launcher.exe:0x004208e0");
}

// anchor: launcher.exe:0x00420320 (vtable 0x004b0bb0 slot 7)
uint32_t CLTLoginState_State16_0x4b0bb0::GetStateId() const {
    return 16;
}

// anchor: launcher.exe:0x004207c0 (vtable 0x004b0bb0 slot 8)
uint32_t CLTLoginState_State16_0x4b0bb0::Slot8_HandleAuxiliaryEvent(uint32_t param1, void* context) {
    // Ownership note from the current vtable/xref pass:
    // - `0x4207c0` is slot 8 of `CLTLoginState_State16_0x4b0bb0` vtable `0x004b0bb0`
